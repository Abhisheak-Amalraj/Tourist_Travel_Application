...
class PlateParkPage extends StatefulWidget {
  const PlateParkPage({Key? key}) : super(key: key);

  @override
  State<PlateParkPage> createState() => _PlateParkPageState();
}

class _PlateParkPageState extends State<PlateParkPage> {
  @override
  Widget build(BuildContext context) {
    return Selector<PlateLogic, List<Results>>(
      ...
      selector: (context, logic) => logic.park.value ?? [],
