...
import 'widget/distance_view.dart';

class PlateBuildingsPage extends StatefulWidget {
  const PlateBuildingsPage({Key? key}) : super(key: key);

  @override
  State<PlateBuildingsPage> createState() => _PlateBuildingsPageState();
}

class _PlateBuildingsPageState extends State<PlateBuildingsPage> {
  @override
  Widget build(BuildContext context) {
    return Selector<PlateLogic, List<Results>>(
      ...
      selector: (context, logic) => logic.buildings.value ?? [],
