...
class PlateMuseumPage extends StatefulWidget {
  const PlateMuseumPage({Key? key}) : super(key: key);

  @override
  State<PlateMuseumPage> createState() => _PlateMuseumPageState();
}

class _PlateMuseumPageState extends State<PlateMuseumPage> {
  @override
  Widget build(BuildContext context) {
    return Selector<PlateLogic, List<Results>>(
      ...
      selector: (context, logic) => logic.museum.value ?? [],
